...
* add RGAA62 validation rule for link elements in the core audit process ([57fe340](https://github.com/a11ylint/core/commit/57fe340))
* add RGAA911 & RGAA913 validation rule for heading elements ([7671e43](https://github.com/a11ylint/core/commit/7671e43))
* add RGAA911 & RGAA913 validation rule for heading elements in core process ([b461ac4](https://github.com/a11ylint/core/commit/b461ac4))
* adding RGAA3 virtual mode, adding it in core.ts and fixing rgaa rules grouping in results ([1f512f1](https://github.com/a11ylint/core/commit/1f512f1))
* implement RGAA11 accessibility checks and tests for form fields ([a01f4cc](https://github.com/a11ylint/core/commit/a01f4cc))
* implement RGAA62 validation rules for link elements in DOM and virtual modes ([0e4e9a7](https://github.com/a11ylint/core/commit/0e4e9a7))

### Bug Fixes

* fixing type name in RGAA3 ([444de9c](https://github.com/a11ylint/core/commit/444de9c))
