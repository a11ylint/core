  ...
  private RGAA112_dom(
    ...
    elements.forEach(el => {
      if (el instanceof HTMLInputElement || el instanceof HTMLSelectElement || el instanceof HTMLTextAreaElement) {
        ...
        // Find labels that reference this element
        ...
        // Also check if there are labels pointing to this element but the element has no id
        if (!id) {
